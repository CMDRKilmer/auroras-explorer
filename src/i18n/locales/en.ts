export const en = {
  ...
  home: {
    welcome: 'Welcome to Auroras Explorer',
    description:
      'Explore the collection of tools for Prosperous Universe. Use the links below to navigate to different tools and resources available in the Auroras Explorer.',
    featuredTools: 'Featured Tools and Resources',
    featuredToolsDescription:
      'The following tools are not provided by us, but they are very essential tools. We recommend you to use them.',
    contactSuggestion:
      'If you have any suggestions for tools to be added to the gallery, please feel free to contact us. We are always looking for ways to improve the Auroras Explorer and provide more value to the Prosperous Universe community.',
  },
  sidebar: {
  ...
  group: {
    ...
    form: {
      ...
      namePlaceholder: 'My Corp Group',
      nameRequired: 'Group name is required.',
      fioGroupIdLabel: 'FIO Group ID',
      fioGroupIdPlaceholder: 'e.g. 12345',
      fioGroupIdRequired: 'FIO Group ID is required.',
      useMyToken: 'Use my FIO API token',
      fioApiTokenLabel: 'FIO API Token',
      fioApiTokenPlaceholder: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
      fioApiTokenRequired: 'FIO API Token is required.',
      fioApiTokenDescription: 'A FIO API token with access to this group.',
  ...
  productionLine: {
    title: 'Production Line Explorer',
    controls: {
      zoomIn: 'Zoom In',
      zoomOut: 'Zoom Out',
      fitView: 'Fit View',
  ...
  configTransform: {
    ...
    description: "Don't ask me what this is. If you know it, you know it.",
    location: 'Location',
    currency: 'Currency',
  ...
  game: {
    ...
    selectCommodityExchange: 'Select Commodity Exchange',
    loading: 'Loading...',
  ...
  auth: {
    ...
    username: 'Username',
    password: 'Password',
    thisPageRequiresAuthorization: 'This Page Requires Authorization',
    fioToken: 'FIO Token',
    authorize: 'Authorize',
  },
  errors: {
